...
<div class="container">
    ...
    <datatables:table id="owners" data="${selections}" cdn="true" row="owner" theme="bootstrap2" 
        ...
        <datatables:column title="Name" cssStyle="width: 150px;" display="html">
            <spring:url value="/owner/{ownerId}" var="ownerUrl">
        ...
        <datatables:column title="Address" property="address.addressLine1" cssStyle="width: 200px;"/>
        <datatables:column title="City" property="address.city"/>
